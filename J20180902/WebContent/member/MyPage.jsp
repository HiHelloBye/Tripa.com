								...
								<section>
									...
									<div class="content">
										<table class="table table-bordered table-hover" style="text-align: center; background-color:white;  border: 1px solid #dddddd;" >
												<thead>
													<tr>
														<th colspan="3"><h3 style="text-align: center;">나의 회원정보</h3></th>
													</tr>
												</thead>
												<tbody>	
													...
													<tr>
														<td style="width: 110px;"><h5>적립금</h5></td>
														<td><input class="form-control" id="saving_pnt" name="saving_pnt" maxlength="20"  value="${member.saving_pnt}" readonly></td>
													</tr>
											...
											<div class="panel-footer">
										        <a data-original-title="Scrap List" data-toggle="tooltip"><i class="glyphicon glyphicon-user"></i></a>
										        <span class="pull-right">
										            <a href="../member/ModifyForm.do" data-original-title="Modify this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
										            <a href="../member/UserDeleteForm.do" data-original-title="Remove this user" data-toggle="tooltip"  type="button" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
									        	</span>
									   		</div>
