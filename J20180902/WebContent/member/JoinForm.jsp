...
<nav style="width: 130px;" class="navbar navbar-default">
		<div class="navbar-header">
			<a class="navbar-brand" href="index.do">Tripa.com</a>
		</div>
	</nav>
		<nav class="navbar navbar-default">
		<div class="navbar-header">
			<a class="navbar-brand" href="index.do">트리콤</a>
		</div>
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li><a href="../board/boardList.do">여행후기</a></li>
			</ul>
	       	<%
			if(user_id == null ) {
			%>
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="active"><a href="JoinForm.do">회원가입</a></li>
			</ul>
			<%
			...
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						...
						<td style="width: 110px;"><button class="button primary" onclick="registerCheckFunction();" type="button">중복체크</button></td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>비밀번호</h5></td>
						<td colspan="2"><input onkeyup="passwordCheckFunction();" class="form-control" id="user_pass1" type="password" name="user_pass1" maxlength="20" placeholder="비밀번호를 입력하세요."></td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>비밀번호 확인</h5></td>
						<td colspan="2"><input onkeyup="passwordCheckFunction();" class="form-control" id="user_pass2" type="password" name="user_pass2" maxlength="20" placeholder="비밀번호 확인을 입력하세요."></td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>이름</h5></td>
						<td colspan="2"><input class="form-control" id="userName" type="text" name="user_name" maxlength="20" placeholder="이름을 입력하세요."></td>
					</tr>
					<tr>
					...
					<tr>
						<td style="width: 110px;"><h5>질문</h5></td>
						<td colspan="2">
							<div class="form-group" style="text-align: center; margin: 0 auto;">
								<div class="col-sm-10">
					...
					<tr>
						<td style="width: 110px;"><h5>답변</h5></td>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" id="user_cell" type="number" name="user_cell" maxlength="20" placeholder="전화번호를 입력하세요."></td>
					</tr>
					<tr>	
