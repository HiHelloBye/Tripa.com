...
<body>
	...
	<div class="container">
		<form method="post" action="UserDeletePro.do" >
			<table class="table table-bordered table-hover" style="text-align: center; background-color:white;  border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" id="user_pass1" type="password" name="user_pass" maxlength="20" placeholder="비밀번호 입력"></td>
					</tr>
					<tr>	
						<td style="text-align: left;" colspan="3"><h5 style="color: red;"></h5><input onclick="return confirm('정말로 삭제하시겠습니까?')" class="btn btn-primary pull-right" type="submit" value="탈퇴"></td>
					</tr>
				</tbody>
			</table>
		</form>
