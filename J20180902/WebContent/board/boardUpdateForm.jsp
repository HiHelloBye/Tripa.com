...
<nav style="width: 130px;" class="navbar navbar-default">
	...
	<form action="boardUpdatePro.do" id="frm" method="post">
		<!-- 팝업에서 받아온 값을 변경없이 보냄 -->
		<input type="hidden" name="user_id" value="${user_id}">
			...
			<div id="main">
				<div class ="inner">
					<section id="banner">
						<div class="content">
							<h1>
								<input type="text"	name="board_title" value="${board.board_title}" placeholder="제목" rows="1" style="resize: none;" required ></textarea>
							</h1>
						</div>
					</section>
					<!-- Content_text -->
					...
					<hr class="major">
						<span>
							<p>태그</p> 
							<input type="text" name="hashtag" value="${hashtag}" style="width:550px;" placeholder="예) 제주도 제주도여행기 입력(최대10개) 공백으로 구분됩니다">
						</span>
					<!-- 수정하기 -->
					<hr class="major">
					<div class="features">
						<article>
							...
							<div class="content">
								<p>
									<input type="button" class="button fit small" id="savebutton" value="수정완료">
								</p>
							</div>
						</article>
						<article></article>
