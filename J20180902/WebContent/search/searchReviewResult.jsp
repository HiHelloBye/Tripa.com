...
<html>
	<head>
		...
		<link rel="stylesheet" href="../searchCSS/assets/css/main.css?ver=7" />
	...
	<body class="index is-preload">
		...
		<article id="main">
			<section class="wrapper style3 container special">
                <header class="major">
                    <h2><strong>${keyword }</strong> 으로 검색한 결과 <strong>${totCnt}</strong> 개의 리뷰가 있습니다</h2>
                </header>
                <form  class="frm" action="search.do" method="post">
                    <input type="hidden" name="keyword" value="${keyword }">
                    <input type="hidden" name="switch" value="review">
                    <select onchange="changeTable()" id="reviewsort" name="reviewsort">	
                ...
                <div class="best1">
					<c:if test="${totCnt > 0 }">
						<div class="row">
							<c:forEach var="board" items="${listBoard1}">	
									<div class="col-6 col-12-narrower">
										<section>
											...
											<p>
                                                ...
                                                <br />
												Views ${board.look} Scraps ${board.scrap_cnt}
											</p>
										</section>
									</div>
							</c:forEach>
							<c:forEach var="board" items="${listBoard2}">
								<div class="col-6 col-12-narrower">
									<section>
										<a href="../board/boardContent.do?num=${board.posting_no}&pageNum=${currentPage}" class="image featured"><img src="${board.photo}" alt="" /></a>
										<header>
