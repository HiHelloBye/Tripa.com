				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="index.html" class="logo"><strong>숙소관리</strong> by ADMIN</a>
							...
							<!-- Section -->
								<section>
									...
									<div class="content">
										<form action="adminAccomUpdatePro.do" method="post">
											<input type="hidden" name="accom_no" value="${accom.accom_no}">
											<input type="hidden" name="pageNum" value="${pageNum}">
											<table>
												<caption><h2>숙소 수정</h2></caption>
												<tr align="center"><td style="background-color:#d5b6d6"">숙소 번호</td><td>${accom.accom_no}</td></tr>
												...
												<tr align="center"><td style="background-color:#d5b6d6">숙소 종류</td><td><input type="text" class="field" name="accom_type" required="required"
												...
												<tr align="center"><td style="background-color:#d5b6d6">지도</td><td><input type="text" class="field" name="accom_map" required="required"
													 value="${accom.accom_map}"></td></tr>
												<tr align="center"><td style="background-color:#d5b6d6">내용</td><td><pre><textarea rows="10" cols="40" name="content"
													required="required" class="field">${accom.accom_cont}</textarea></pre></td></tr>
												<tr align="center"><td style="background-color:#d5b6d6">별점</td><td>수정 시, 작성하실 수 없습니다.</td></tr>
												<tr align="center"><td style="background-color:#d5b6d6">국내외</td><td><input type="text" class="field" name="inout" required="required"
												...
												<tr align="right">
													<td colspan="2">
													<div>
														<input type="reset" value="수정 취소" class="field2" style="background-color:white">
														<input type="submit" value="수정 완료" class="field2" style="background-color:white">
													</div>
													</td>
												</tr>
											</table>
