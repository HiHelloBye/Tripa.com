				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="index.html" class="logo"><strong>공지관리</strong> by ADMIN</a>
							...
							<!-- Section -->
								<section>
									...
									<div class="content">
										<form action="adminNoticeUpdatePro.do" method="post">
												<input type="hidden" name="posting_no" value="${board.posting_no}">
												<input type="hidden" name="pageNum" value="${pageNum}">
												<table>
													<caption><h2>공지사항 수정</h2></caption>
													<tr align="center"><td style="background-color:#d5b6d6">글 번호</td><td>${board.posting_no}</td></tr>
													<tr align="center"><td style="background-color:#d5b6d6">글 제목</td><td><input type="text" name="board_title" required="required"
													 value="${board.board_title}" class="field"></td></tr>
													 
													<tr align="center"><td style="background-color:#d5b6d6">수정일</td><td><%
													...
													out.println(today);
													%> </td></tr>
													<tr align="center"><td style="background-color:#d5b6d6">내용</td><td><pre><textarea rows="10" cols="40" name="content_text"
														required="required" class="field">${board.content_text}</textarea></pre></td></tr>
