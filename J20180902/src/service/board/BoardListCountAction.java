...
import dao.Board;
import dao.BoardDao_ListCount;

import service.CommandProcess;

public class BoardListCountAction implements CommandProcess {

public String requestPro(HttpServletRequest request,
		HttpServletResponse response) throws ServletException, IOException {
		
		BoardDao_ListCount bd = BoardDao_ListCount.getInstance();
...
//				int endRow       = startRow + pageSize - 1;         //마지막 줄
...
//				request.setAttribute("list",        list);          //목록
				request.setAttribute("list1",       list1);          //목록
				request.setAttribute("list2",       list2);          //목록
				request.setAttribute("list3",       list3);          //목록
