...
public class adminAccomDeleteListAction implements CommandProcess {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			int startNum = totCnt-startRow+1;            //초기화시 38
							 //초기화시          1        10
			List<Accom> list = ad.list(startRow,endRow);
		...
		return "adminAccomDeleteList.jsp";
	}
